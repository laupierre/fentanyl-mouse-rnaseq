...
mygsea (res, "hippocampus_deseq2_FentanylvsControl_gsea_reactome_pathways.xlsx")


# Withdrawal vs Control
res <- read.xlsx ("hippocampus_deseq2_WithdrawalvsControl_differential_expression.xlsx")
mygsea (res, "hippocampus_deseq2_WithdrawalvsControl_gsea_reactome_pathways.xlsx")


# Withdrawal vs Fentanyl
res <- read.xlsx ("hippocampus_deseq2_WithdrawalvsFentanyl_differential_expression.xlsx")
mygsea (res, "hippocampus_deseq2_WithdrawalvsFentanyl_gsea_reactome_pathways.xlsx")
